# Categories — Phân nhóm & Tags

> File này trả lời: **đặt công nghệ vào nhóm nào?** và **gắn tag nào?**  
> Mục lục đầy đủ: [../README.md](../README.md) · Danh sách star: [../repos/README.md](../repos/README.md) · Cách viết bài: [../technologies/WRITING.md](../technologies/WRITING.md)

---

## Quy tắc gán (ngắn gọn)

1. Chọn **đúng một** Primary theo use case chính khi star.  
2. Gắn **mọi** Tags khớp tính năng thật (có MCP + RAG + CLI → gắn cả ba).  
3. Harness CLI-Anything: Primary theo **domain ngang**; luôn có `harness` (+ `cli`).  
4. Xuất hiện 2 chỗ mục lục (vd. drawio-skill): Primary = Agents; liệt kê lại dưới DevTools cùng Tags.  
...
**Phân bố ★ hiện tại:** Agents 54 · Speech 19 · Image/Video 19 · UI 6 · DevTools 46 · CV 7 · Security 3 · **= 154**
...
Xem chú giải đầy đủ trong [README.md § Chú giải Tags](../README.md#chú-giải-tags).  
Viết bài công nghệ: [WRITING.md](../technologies/WRITING.md).
