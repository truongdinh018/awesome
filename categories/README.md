...
| **Open Interpreter** | `coding-agent` `agent` `cli` `skill` `mcp` `computer-use` | [openinterpreter.md](../technologies/mcp-ai-agents/openinterpreter.md) |
| **Cline** | `coding-agent` `agent` `cli` `desktop` `mcp` `self-host` `skill` | [cline.md](../technologies/mcp-ai-agents/cline.md) |
| **Continue** | `coding-agent` `agent` `cli` `desktop` `mcp` `self-host` | [continue.md](../technologies/mcp-ai-agents/continue.md) |
...
| **Vikunja App** | `self-host` `mobile` `desktop` `workspace` | [vikunja-app.md](../technologies/devtools/vikunja-app.md) |
