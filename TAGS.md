...
| `coding-agent` | OpenHands · Addy's Agent Skills · Understand Anything · OpenMontage · **Happy** · **Vibe Kanban** · **Lanes** · **Claude Peers** · **DeerFlow** · **CC WF Studio** · **Spec Kit** · **AI Eng Coach** · **Easy-Vibe** · **Karpathy Guidelines** · **Matt Pocock Skills** · **Claude-Mem** · **GitReverse** · **Semble** · **Gitingest** · **ghgrab** · **RTK** |
| `skill` / `prompt` | CLI-Anything · Addy's Agent Skills · Ponytail · **Taste Skill** · **Caveman** · **Karpathy Guidelines** · **Matt Pocock Skills** · **Spec Kit** · **AI Eng Coach** · **Easy-Vibe** · **GitReverse** · **knowledge-work-plugins** · **CC WF Studio** · **OpenSpace** · prompts.chat · OpenMontage · **Toonflow** · **docmd** · [**Skill registries**](technologies/bookmarks/skill-registries.md) |
