...
| **Vikunja App** | DevTools | `self-host` `desktop` `workspace` `api` | Vikunja App là client Flutter cross-platform cho Vikunja — to-do/Kanban/Gantt self-host; kết nối API backend Vikunja stable (alpha pre-release). | [vikunja-app.md](technologies/devtools/vikunja-app.md) |
