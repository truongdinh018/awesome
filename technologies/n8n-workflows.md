...
Không thay [n8n harness](cli-anything/n8n.md) / upstream [n8n-io/n8n](https://github.com/n8n-io/n8n) — đây là **dataset templates**. Peer: [Horizon](horizon.md) (news pipeline), [zca-bridge](zca-bridge.md) / [EpicStaff](epicstaff.md) (orchestration khác stack).
...
- Peers: [cli-anything/n8n.md](cli-anything/n8n.md) · [horizon.md](horizon.md) · [zca-bridge.md](zca-bridge.md) · [epicstaff.md](epicstaff.md)
