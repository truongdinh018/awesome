...
> Face swap offline — build trên [InsightFace](insightface.md) / FaceFusion / TinyFace
...
**Cùng kiểu:** [Deep-Live-Cam](deep-live-cam.md) (live webcam deepfake), [InsightFace](insightface.md) (engine face analysis), [ComfyUI](comfyui.md) (pipeline generative rộng hơn).
...
| Face embedding / verify API | → [InsightFace](insightface.md) |
...
- Peers: [deep-live-cam.md](deep-live-cam.md) · [insightface.md](insightface.md) · [comfyui.md](comfyui.md)
