...
**Cùng kiểu:** [Duckle](duckle.md) (ETL canvas + DuckDB), [Pathway](pathway.md) (stream ETL code), [LocalAI](localai.md) / Ollama (model local cho AI SQL), [Semble](semble.md) (code search MCP — khác domain).
...
| Live RAG/stream ingest | → [Pathway](pathway.md) |
...
- Peers: [duckle.md](duckle.md) · [pathway.md](pathway.md) · [localai.md](localai.md) · [semble.md](semble.md)
