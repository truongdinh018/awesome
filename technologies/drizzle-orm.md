...
**Cùng kiểu:** [Tabularis](tabularis.md) (SQL IDE + MCP), [VeloxDB](veloxdb.md) (Postgres GUI), [Duckle](duckle.md) (ETL DuckDB), [Pathway](pathway.md) (stream ETL code).
...
| Stream RAG / live ETL Python | → [Pathway](pathway.md) |
...
- Peers: [tabularis.md](tabularis.md) · [veloxdb.md](veloxdb.md) · [duckle.md](duckle.md) · [pathway.md](pathway.md)
