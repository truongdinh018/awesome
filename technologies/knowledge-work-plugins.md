...
**Cùng kiểu:** [Addy's Agent Skills](agent-skills.md) / [Taste Skill](taste-skill.md) (skills coding/frontend), [skill-registries](skill-registries.md) (hubs), [Google Workspace CLI](google-workspace-cli.md) (office CLI).
...
| Browse skill marketplace | → [skill-registries](skill-registries.md) |
...
- Peers: [agent-skills.md](agent-skills.md) · [taste-skill.md](taste-skill.md) · [skill-registries.md](skill-registries.md) · [google-workspace-cli.md](google-workspace-cli.md) · [prompts-chat.md](prompts-chat.md)
