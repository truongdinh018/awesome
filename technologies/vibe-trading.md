...
Khác [Whisper Money](whisper-money.md) (sổ chi tiêu, không AI trading) và [Vibe Kanban](vibe-kanban.md) (board coding agents).
...
| MCP + Alpha Zoo bench | ✅ |
| Personal finance ledger | → [Whisper Money](whisper-money.md) |
...
- Peers: [hermes-agent.md](hermes-agent.md) · [atomic-agents.md](atomic-agents.md) · [mirofish.md](mirofish.md) · [vibe-kanban.md](vibe-kanban.md) · [whisper-money.md](whisper-money.md)
