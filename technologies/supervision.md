...
**Cùng kiểu:** [InsightFace](insightface.md) (face ID chuyên sâu), [ALPR](alpr.md) (biển số edge), [LocateAnything-3B](locate-anything.md) (VL grounding), [MagicMirror](magicmirror.md) (face-swap app).
...
- Peers: [insightface.md](insightface.md) · [alpr.md](alpr.md) · [locate-anything.md](locate-anything.md) · [magicmirror.md](magicmirror.md)
