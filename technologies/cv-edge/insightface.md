...
**Cùng kiểu:** [UniFace](uniface.md) (API Python unified + ONNX nhẹ hơn), [ALPR](alpr.md) (biển số, khác domain), [LocateAnything-3B](locate-anything.md) (grounding/OCR, không face ID), [MagicMirror](../image-video/magicmirror.md) (desktop face-swap UX).
...
- Peers: [uniface.md](uniface.md) · [alpr.md](alpr.md) · [locate-anything.md](locate-anything.md) · [magika.md](../devtools/magika.md)
