...
**Cùng kiểu:** [Trilium](trilium.md) (personal hierarchical KB), [Khoj](khoj.md) / [Open Notebook](open-notebook.md) (AI chat trên KB), [docmd](docmd.md) (agent docs MCP), Obsidian [harness](cli-anything/obsidian.md), [drawio-skill](drawio-skill.md).
...
- Peers: [trilium.md](trilium.md) · [khoj.md](khoj.md) · [docmd.md](docmd.md) · [open-notebook.md](open-notebook.md) · [drawio-skill.md](drawio-skill.md)
