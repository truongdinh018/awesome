...
**Cùng kiểu:** [Puppeteer](puppeteer.md) (CDP plain), [Chrome DevTools MCP](chrome-devtools-mcp.md) (agent DevTools), [Scrapling](scrapling.md) (stealth fetch), [Crawl4AI](crawl4ai.md), [Stagehand](stagehand.md) / [Midscene](midscene.md) (agent UI).
...
| Adaptive scrape + MCP | → [Scrapling](scrapling.md) |
...
- Peers: [puppeteer.md](puppeteer.md) · [scrapling.md](scrapling.md) · [crawl4ai.md](crawl4ai.md) · [chrome-devtools-mcp.md](chrome-devtools-mcp.md) · [stagehand.md](stagehand.md)
