...
**Cùng kiểu:** [Crawl4AI](crawl4ai.md) (OSS crawl → MD, local-first), [Scrapling](scrapling.md) (adaptive scrape + MCP), [Hyper-Extract](hyper-extract.md) (text→graph), [Stagehand](stagehand.md) (browser agent).
...
| Full browser agent (fill forms) | → [Stagehand](stagehand.md) / [Midscene](midscene.md) |
...
- Peers: [crawl4ai.md](crawl4ai.md) · [scrapling.md](scrapling.md) · [hyper-extract.md](hyper-extract.md) · [pathway.md](pathway.md) · [stagehand.md](stagehand.md)
