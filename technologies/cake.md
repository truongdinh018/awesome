...
**Cùng kiểu:** [exo](exo.md) (cụm Mac + MLX), [LocalAI](localai.md) (nhiều backend, chín hơn), [AirLLM](airllm.md) (một GPU nhỏ chạy model lớn), [VibeVoice](vibevoice.md) (TTS).
...
- Peers: [exo.md](exo.md) · [localai.md](localai.md) · [airllm.md](airllm.md) · [vibevoice.md](vibevoice.md) · [freellmapi.md](freellmapi.md)
