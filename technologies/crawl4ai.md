...
**Cùng kiểu:** [Scrapling](scrapling.md) (adaptive DOM + MCP), [Hyper-Extract](hyper-extract.md) (text→graph), [Stagehand](stagehand.md) / [Puppeteer](puppeteer.md) (browser agent / CDP), [SurfSense](surfsense.md) / [Pathway](pathway.md) (RAG ingest).
...
| Click/fill form agent | → [Stagehand](stagehand.md) / [Midscene](midscene.md) |
...
- Peers: [scrapling.md](scrapling.md) · [hyper-extract.md](hyper-extract.md) · [pathway.md](pathway.md) · [surfsense.md](surfsense.md) · [stagehand.md](stagehand.md)
