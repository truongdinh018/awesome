...
**Cùng kiểu:** [Addy's Agent Skills](agent-skills.md) (lifecycle eng), [Ponytail](ponytail.md) (YAGNI), [ScreenCoder](screencoder.md) / [HTML Anything](html-anything.md) (UI→code / HTML agents), [HyperFrames](hyperframes.md) (motion video).
...
- Peers: [agent-skills.md](agent-skills.md) · [ponytail.md](ponytail.md) · [screencoder.md](screencoder.md) · [html-anything.md](html-anything.md)
