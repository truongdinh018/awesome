...
**Cùng kiểu:** [ALPR](alpr.md) (biển số, khác domain), [LocateAnything-3B](locate-anything.md) (grounding/OCR, không face ID), [MagicMirror](magicmirror.md) (desktop face-swap UX).
...
| Plate / general OCR | → [ALPR](alpr.md) / [MinerU](mineru.md) |
...
- Peers: [alpr.md](alpr.md) · [locate-anything.md](locate-anything.md) · [magika.md](magika.md)
